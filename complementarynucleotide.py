...
plt.plot(range(Aminfreq,Amaxfreq+1,10),Afreqlist2,label='A',linewidth=1)
plt.plot(range(Tminfreq,Tmaxfreq+1,10),Tfreqlist2,label='T',linewidth=1)
plt.plot(range(Cminfreq,Cmaxfreq+1,10),Cfreqlist2,label='C',linewidth=1)
plt.plot(range(Gminfreq,Gmaxfreq+1,10),Gfreqlist2,label='G',linewidth=1)
plt.legend()
plt.show()
